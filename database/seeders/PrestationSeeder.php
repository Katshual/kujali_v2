...
class PrestationSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('prestations')->insert([
            ...
            ['titre' => 'Massage sportif', 'description' => 'Composé de techniques suédoises, ce massage a une action à la fois décontractée, drainante, et fortifiante. Il procure une grande détente musculaire et favorise une meilleure amplitude de mouvements.'],
        ]);
    }
}
